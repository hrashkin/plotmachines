...
b) Some stories may have instances of offensive words (swear words, slurs) even though the full story is not offensive.  Before training, add a pre-processing step to replace these words with some sort of special token.
