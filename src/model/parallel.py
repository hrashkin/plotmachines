# Code referenced from https://gist.github.com/thomwolf/7e2407fbd5945f07821adae3d9fd1312
...
class DistributedDataParallelModel(torch.nn.parallel.distributed.DistributedDataParallel):
...
class DataParallelCriterion(DataParallel):
    ...
    def forward(self, inputs, *targets, only_return_losses=False, **kwargs):
        # input should be already scatterd
        # scattering the targets instead
        if not self.device_ids:
            return self.module(inputs, *targets, only_return_losses=only_return_losses, **kwargs)
